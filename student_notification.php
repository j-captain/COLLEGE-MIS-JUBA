                ...
                <div class="row-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        if (mysqli_num_rows($school_year_query) > 0) {
                            ...
                            echo '<li><a href="#">School Year: ' . $school_year . '</a></li>';
                        } else {
                            echo '<li><a href="#"><b>My Class</b></a><span class="divider">/</span></li>';
                            echo '<li><a href="#">School Year: Unknown</a></li>';
                        }
                        ?>
                    </ul>
                    <!-- end breadcrumb -->
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form action="read.php" method="post">
                                    <?php if (isset($not_read) && $not_read != '0') { ?>
                                    ...
                                    if (mysqli_num_rows($query) > 0) {
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            $yes = mysqli_num_rows($query_yes_read) > 0 ? mysqli_fetch_array($query_yes_read)['student_read'] : "no";
                                    ?>
